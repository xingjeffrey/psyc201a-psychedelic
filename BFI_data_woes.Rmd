...
```{r}
#Figure 1A, BFI Trait Scores
    # need to figure out how they got the scale and means they did for figure 1A
    # I think they measured means for the individual index items, 
    # but I'm not sure how the items correspond to the OCEAN factors
df.bfi = df.f_ocean %>% 
  select(`1_openness`, `1_conscientiousness`, `1_extraversion`,
         `1_agreeableness`, `1_neuroticism`)
summary(df.bfi$`1_openness`)
```
